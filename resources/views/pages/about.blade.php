                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Jallu Ramadhan</h4>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Muhammad Rafly Tharhan</h4>
                                    <p class="card-text">Android Developer</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Nadia Nurul Hikmah</h4>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Robby Kurnia Aprilian</h4>
                                    <p class="card-text">Web Developer</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title">Vidi Ayuningtyas</h4>
